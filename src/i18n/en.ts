export const en = {
  ...
  cta: {
    ...
    whatsapp: "WhatsApp",
    email: "Email Us",
    viewTuroFleet: "Browse Our Turo Fleet",
    becomeHost: "Host My Car With SPEEDX",
  ...
  advantages: {
    ...
    items: [
      ...
      {
        title: "24/7 Delivery",
        body: "Round-the-clock vehicle delivery. Red-eye flights, early check-ins, late returns — we cover it, you don't have to think about it.",
      },
    ],
  },
  hosting: {
    ...
    whoItsFor: {
      ...
      items: [
        {
          title: "Snowbirds & Frequent Travelers",
          body: "You live part of the year outside Vancouver, or travel frequently. Your car sits in the garage losing value. Let us list it while you're away — you earn rental income instead of paying depreciation.",
        },
        {
    ...
    whatIsTuro: {
      title: "New to Turo? Here's What You Need to Know",
      subtitle:
        "Turo is North America's largest peer-to-peer car sharing marketplace — often described as the 'Airbnb for cars.' Car owners list their vehicles; travelers and locals book them by the hour, day, or week.",
      points: [
        {
        ...
        },
        {
          ...
          body: "Travelers book directly through Turo's app and website. Hosts like us manage the pickup, delivery, cleaning, and turnaround.",
        },
        {
          title: "We do everything for you",
          body: "Listing photos, dynamic pricing, guest communication, airport delivery, cleaning, refueling, maintenance, damage claims — everything is handled by our team.",
        },
      ],
    },
    howItWorks: {
      title: "How Hosting With SPEEDX Works",
      steps: [
        {
          num: "01",
    ...
    faq: {
      ...
      items: [
        {
          q: "What kind of cars do you accept?",
          a: "We accept most sedans, SUVs, trucks, EVs, and premium vehicles in good mechanical and cosmetic condition, typically 10 years old or newer. Contact us with your vehicle details for a specific assessment.",
        },
        {
  ...
  contact: {
    ...
    whatsapp: {
      title: "WhatsApp",
      body: "Chat with us anytime on WhatsApp — English or Chinese.",
    },
    phone: {
      title: "Phone",
    ...
    email: {
      title: "Email",
      body: "Drop us a line — we reply within 24 hours.",
    },
    location: {
  ...
  about: {
    ...
    values: {
      ...
      items: [
        {
          title: "Transparency",
          body: "Clear fees, clear statements, clear communication. No hidden markups on parts or service.",
        },
        {
          title: "Vertical Integration",
          body: "Storefront + shop + fleet + airport proximity. We control every step so owners get maximum reliability.",
        },
        {
          title: "Owner First",
          body: "Every policy, fee, and process is designed to maximize the owner's earnings — not ours.",
        },
      ],
    },
  },
